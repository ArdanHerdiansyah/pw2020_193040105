...
<body>
    ...
    <button type="">
        ...
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="cari">Login</button>
        </a>
    </button>
                    ...
                    <div class="col s10 m4" style="float: left;">
                        <div class="card">
                            ...
                            <div class="card-action">
                                <a href="php/detail.php?id=<?= $pakai['id'] ?>" style="text-align : center;">Beli ?</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
