...
<body style="background-color: #008040;">
	...
	<form action="" method="get">
		<input type="text" name="keyword" id="keyword" placeholder="masukan keyword pencarian.." size="30">
	...
	<div class ="footer">
		<p style="text-align: center;">Copyright &copy; 2020. Ardan Herdiansyah Universitas Pasundan Bandung</p>
    </div>
